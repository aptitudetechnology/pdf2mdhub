...
exports.isNumber = exports.isNumberedListItem = exports.isListItem = exports.isListItemCharacter = exports.extractEndingNumber = exports.extractNumbers = exports.filterOut = exports.filterOutWhitespaces = exports.filterOutDigits = exports.toCharcodes = exports.isDigit = exports.DASHS_CHAR_CODES = exports.PERIOD_CHAR_CODES = exports.MAX_DIGIT_CHAR_CODE = exports.MIN_DIGIT_CHAR_CODE = exports.WHITESPACE_CHAR_CODE = exports.TAB_CHAR_CODE = void 0;
...
function filterOutDigits(text) {
    return String.fromCharCode.apply(String, toCharcodes(text).filter(function (code) { return !isDigit(code); }));
}
...
function filterOut(text, codes) {
    return String.fromCharCode.apply(String, toCharcodes(text).filter(function (code) { return !codes.includes(code); }));
}
...
function extractEndingNumber(text) {
    ...
    if (match) {
        (0, assert_1.assert)(match.length == 1, "Expected only one match, but got ".concat(match));
